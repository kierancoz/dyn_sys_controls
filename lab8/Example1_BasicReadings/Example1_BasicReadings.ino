/*
  ...
  Open the SerialUSB monitor at 9600 baud to see the output
*/
...
void setup()
{
  ...
  SerialUSB.println("Qwiic Scale Example");

  Wire.begin();

  if (myScale.begin() == false)
  {
    SerialUSB.println("Scale not detected. Please check wiring. Freezing...");
    while (1);
  }
  SerialUSB.println("Scale detected!");
}
